...
#Programme to make a number of directories with a consecutive numbering
of the users choice
...
echo 'String 1 is the part of the directory name before the variable
number, pls type string 1:'
read str1
echo 'String 2 is the part of the directory name after the variable
